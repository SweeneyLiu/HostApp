...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SAMPLE_PLUGIN_PKG = "com.lsw.pluginapp";
//    private static final String SAMPLE_PLUGIN_PKG = "com.iqiyi.plugin.sample";

    @BindView(R.id.plugin_state)
    TextView pluginState;
    @BindView(R.id.install_plugin)
    Button installPlugin;
    @BindView(R.id.launch_plugin)
    Button launchPlugin;
    @BindView(R.id.uninstall_plugin)
    Button uninstallPlugin;
    ...
    void installPlugin() {
        ...
        String apkName = SAMPLE_PLUGIN_PKG + ".apk";
     ...
     * 启动插件
     */
    @OnClick(R.id.launch_plugin)
    void launchPlugin() {

        Intent intent = new Intent();
        ComponentName cn = new ComponentName(SAMPLE_PLUGIN_PKG, SAMPLE_PLUGIN_PKG + ".MainActivity");  // 启动默认入口Activity
